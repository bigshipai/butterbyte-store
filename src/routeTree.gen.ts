...
import { Route as UpiPayRouteImport } from './routes/upi-pay'
...
const UpiPayRoute = UpiPayRouteImport.update({
  id: '/upi-pay',
  path: '/upi-pay',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface RootRouteChildren {
  ...
  UpiPayRoute: typeof UpiPayRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/upi-pay': {
      ...
      path: '/upi-pay'
      fullPath: '/upi-pay'
      preLoaderRoute: typeof UpiPayRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/track-order': {
      id: '/track-order'
